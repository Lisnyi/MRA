...
export const PlayersList: FC<Props> = ({ playersList, setPlayersList, totalVotes, maxVotes, checkQueueOrder, leftVotes, votingInfo, setVotingInfo, addToVote, addVotes, removeFromVote, changeFouls, changeInGameStatus, changeToOutStatus }) => {
